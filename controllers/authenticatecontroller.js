...
exports.signupcontrol = async (req, res) => {
  try {
    ...
    const verificationUrl = `https://placement.Exam-IDE.co.in/authenticate/verify/${randurl}`;
    ...
    try {
      await sendEmails({
        email,
        subject: "Verify your Exam-IDE account",
...
<head>
  ...
  <title>Email Verification - Exam-IDE</title>
...
<body style="margin: 0; padding: 0; font-family: 'Inter', sans-serif; background-color: #f4f4f4; color: #333;">
  <div style="max-width: 600px; margin: 40px auto; padding: 30px; background: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    <h2 style="color: #2e86de; margin-bottom: 20px;">Welcome to Exam-IDE 🎯</h2>
    ...
    <p style="font-size: 14px; color: #888;">
      If you didn't create an account with Exam-IDE, you can safely ignore this email.
    </p>
    <p style="font-size: 14px; color: #888;">
      This verification link will expire in 24 hours.
    </p>
    <p style="font-size: 14px; margin-top: 40px; color: #aaa; text-align: center;">
      &copy; ${currentYear} Exam-IDE. All rights reserved.
    </p>
  </div>
</body>
</html>`;
